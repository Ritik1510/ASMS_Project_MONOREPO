# PACKAGE MANAGER: PNPM 
    - COMMANDS 
        - pnpm add <library-name> --filter <app-name-where-we-wants-to-add-the-ui-lib> --workspace
        Description: this command is used to add the libraries to the apps from the monorepos 
